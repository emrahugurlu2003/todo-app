...
export default function UnstyledSelectControlled() {
  ...
  return (
    <div>
      ...
      >
        <StyledOption value={1}>Urgent</StyledOption>
        <StyledOption value={2}>High</StyledOption>
        <StyledOption value={3}>Medium</StyledOption>
        <StyledOption value={4}>Low</StyledOption>
      </CustomSelect>
